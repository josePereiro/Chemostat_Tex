...
\begin{document}
	...
	% been proposed by \shortcite{fernandez-de-cossio-diaz_characterizing_2017}. 
...
%	% ---------------------------------------------------------------------------------------------------------
% 	% citeRequired8
% 	% 28. jaynesInformationTheoryStatistical1957: Jaynes ET. Information theory and statistical mechanics. Physical review. 1957; 106(4):620. https://doi.org/10.1103/PhysRev.106.620

% 	% 29. jaynesProbabilityTheoryLogic2003: Jaynes ET. Probability Theory: The Logic of Science. Bretthorst GL, editor. Cambridge, UK; New York,
% 	% NY: Cambridge University Press; 2003.

% 	% 30. harteMaximumInformationEntropy2014: Harte J, Newman EA. Maximum Information Entropy: A Foundation for Ecological Theory. Trends in
% 	% Ecology & Evolution. 2014; 29(7):384–389. https://doi.org/10.1016/j.tree.2014.04.009

% 	% 31. schneidmanWeakPairwiseCorrelations2006: Schneidman E, Berry MJ, Segev R, Bialek W. Weak Pairwise Correlations Imply Strongly Correlated
% 	% Network States in a Neural Population. Nature. 2006; 440(7087):1007–1012. https://doi.org/10.1038/nature04701 PMID: 16625187

% 	% 32. demartinoStatisticalMechanicsMetabolic2018: De Martino D, Andersson A, Bergmiller T, Guet CC, Tkačik G. Statistical mechanics for metabolic networks during steady state growth. Nature Communications. % 2018; 9:2988. https://doi.org/10.1038/
% 	% s41467-018-05417-9 PMID: 30061556

% 	% 33. demartinoGrowthEntropyBacterial2016: De Martino D, Capuani F, De Martino A. Growth against entropy in bacterial metabolism: the phenotypic
...
% 	% 34. demartinoQuantifyingEntropicCost2017: De Martino D, Capuani F, De Martino A. Quantifying the entropic cost of cellular growth control. Physical
% 	% Review E. 2017; 96(1):010401. https://doi.org/10.1103/PhysRevE.96.010401 PMID: 29347168
	
%	% ---------------------------------------------------------------------------------------------------------
% 	% citeRequired7
% 	% 18. kivietStochasticityMetabolismGrowth2014: Kiviet DJ, Nghe P, Walker N, Boulineau S, Sunderlikova V, Tans SJ. Stochasticity of metabolism and
% 	% growth at the single-cell level. Nature. 2014; 514(7522):376. https://doi.org/10.1038/nature13582
% 	% PMID: 25186725

% 	% 22. elowitzStochasticGeneExpression2002: Elowitz MB, Levine AJ, Siggia ED, Swain PS. Stochastic gene expression in a single cell. Science.
% 	% 2002; 297(5584):1183–1186. https://doi.org/10.1126/science.1070919 PMID: 12183631

% 	% 23. fernandez-de-cossio-diazCellPopulationHeterogeneity2019: Fernandez-de Cossio-Diaz J, Mulet R, Vazquez A. Cell population heterogeneity driven by stochastic
% 	% partition and growth optimality. arXiv preprint arXiv:180507768. 2018.

% 	% 24. huhRandomPartitioningMolecules2011: Huh D, Paulsson J. Random partitioning of molecules at cell division. Proceedings of the National Academy of Sciences. 2011; 108(36):15004–15009. https://doi.org/10.1073/pnas.1013171108

% 	% 25. wangClonalEvolutionGlioblastoma2016: Wang J, Cazzato E, Ladewig E, Frattini V, Rosenbloom DI, Zairis S, et al. Clonal evolution of glioblastoma under therapy. Nature genetics. 2016; 48(7):768. https://doi.org/10.1038/ng.3590 PMID:

%	% ---------------------------------------------------------------------------------------------------------
% 	% cireRequired6
% 	% novickDescriptionChemostat1950: Novick, A. & Szilard, L. Description of the chemostat. Science 112, 716 (1950). 
% 	% monodGrowthBacterialCultures1949: Monod, J. La technique de culture continue, theorie et applications. ´ Ann. Inst. Pasteur 79, 390–410 (1950). 

%	% ---------------------------------------------------------------------------------------------------------
% 	% citeRequired5
% 	% 20. palssonSystemBiologyPropereties2006: Palsson, B. Ø. Systems Biology: Properties of Reconstructed Networks (Cambridge University Press, 2006). 
...
%	% ---------------------------------------------------------------------------------------------------------
% 	% citeRequire3
% 	% 15. kanehisaDataInformationKnowledge2014: Kanehisa, M. et al. Data, information, knowledge and principle: Back to metabolism in KEGG. Nucleic Acids Research
% 	% 42, 199–205 (2014) 

% 	% 16. caspiMetaCycDatabaseMetabolic2016: Caspi, R. et al. The MetaCyc database of metabolic pathways and enzymes and the BioCyc collection of Pathway/Genome
% 	% Databases. Nucleic Acids Research 42, D459–D471 (2014). 

%	% ---------------------------------------------------------------------------------------------------------
% 	% citeRequired2 
%   % x. mulukutlaMultiplicitySteadyStates2015: 

% 	% 8. europaMultipleSteadyStates2000: Europa AF, Gambhir A, Fu PC, Hu WS. Multiple steady states with distinct cellular metabolism in continuous culture of mammalian cells. Biotechnology and Bioengineering. 2000; 67(1):25–34. https://doi.org/
% 	% 10.1002/(SICI)1097-0290(20000105)67:1%3C25::AID-BIT4%3E3.0.CO;2-K PMID: 10581433 

% 	% 9. cAnalysisCHOCells2001: Altamirano C, Illanes A, Casablancas A, Ga´mez X, Cairo´ JJ, Gòdia C. Analysis of CHO cells metabolic
...
% 	% 10. hayterGlucoseLimitedChemostat1992: Hayter PM, Curling EMa, Baines AJ, Jenkins N, Salmon I, Strange PG, et al. Glucose-Limited 
%   % Chemostat Culture of Chinese Hamster Ovary Cells Producing Recombinant Human Interferon-γ. 
%   % Biotechnology and Bioengineering. 1992; 39:327–335. https://doi.org/10.1002/bit.260390311 PMID: 18600949 

% 	% 11. gambhirAnalysisCellularMetabolism2003: Gambhir A, Korke R, Lee J, Fu PC, Europa AF, Hu WS. Analysis of cellular metabolism of hybridoma
...
% 	% 12. follstadMetabolicFluxAnalysis1999: Follstad BD, Balcarcel RR, Stephanopoulos G, Wang DI. Metabolic flux analysis of hybridoma continuous culture steady state multiplicity. Biotechnology and Bioengineering. 1999; 63(6):675–683. https://
% 	% doi.org/10.1002/(SICI)1097-0290(19990620)63:6%3C675::AID-BIT5%3E3.0.CO;2-R PMID: 10397824

% 	% 13. fernandez-de-cossio-diazCharacterizingSteadyStates2017: Fernandez-de Cossio-Diaz J, Leon K, Mulet R. Characterizing steady states of genome-scale metabolic
...
%	% ---------------------------------------------------------------------------------------------------------
% 	% citeRequired1
% 	% 1. wernerSafetyEconomicAspects1992: Werner, R. G., Walz, F., Noe, W. & Konrad, A. Safety and economic aspects of continuous mammalian cell culture. ´
% 	% Journal of Biotechnology 22, 51–68 (1992). 

% 	% 2. griffithsAnimalCellCulture1992: Griffiths, J. B. Animal cell culture processes - batch or continuous? Journal of Biotechnology 
%   % 22, 21–30 (1992). 

% 	% 3. kadouriMythsMessagesConcerning1997: Kadouri, A. & Spier, R. E. Some myths and messages concerning the batch and continuous culture of animal cells.
% 	% Cytotechnology 24, 89–98 (1997). 

% 	% 4. wernerLetterEditor1998: Werner, R. G. & Noe, W. Letter to the Editor. Cytotechnology 26, 81–82 (1998). 

% 	% 5. croughanFutureIndustrialBioprocessing2015: Croughan, M. S., Konstantinov, K. B. & Cooney, C. The future of industrial bioprocessing: Batch or continuous?
